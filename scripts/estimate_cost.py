...
def main(argv: list[str]) -> int:
    ...
    out += [
        ...
        f"{stored_gib:.2f} GiB to Cloud Storage. A lifecycle rule on the bucket moves objects "
        "to Nearline after 30 days and deletes them after 180, so the line plateaus at about "
        "six months of ZIPs; the figure above is the first month at Standard rates. BigQuery "
        "grows by "
